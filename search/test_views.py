...
class SearchAppViewsTest(TestCase):
    ...
    """Test search announcements(posts) 'POST' success"""
    ...
    """Test post results JSON response used for AJAX request"""
    ...
    """Test search drafts 'POST' success"""
    ...
    """Test drafts results JSON response used for AJAX request"""
