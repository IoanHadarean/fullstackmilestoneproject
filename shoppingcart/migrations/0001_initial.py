# Generated by Django 2.2.3 on 2019-07-16 13:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('DR', 'Dresses'), ('SH', 'Shoes'), ('SU', 'Suits'), ('VL', 'Veils'), ('RN', 'Rings'), ('FL', 'Flowers'), ('HA', 'Hair Accessories'), ('BP', 'Purses'), ('NT', 'Neckties'), ('SH', 'Shirts'), ('BS', 'Belts')], max_length=2)),
