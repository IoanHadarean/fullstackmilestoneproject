...
urlpatterns = [
    ...
    re_path(r'^post/(?P<pk>\d+)/comment/(?P<id>\d+)/reply/$', views.add_reply_to_comment, name='add_reply_to_comment'),
    re_path(r'^comment/(?P<pk>\d+)/approve/$', views.comment_approve, name='comment_approve'),
    re_path(r'^comment/(?P<pk>\d+)/remove/$', views.comment_remove, name='comment_remove'),
    re_path(r'^post/(?P<pk>\d+)/publish/$', views.post_publish, name='post_publish'),
    path('search_posts/', search_views.SearchPosts.as_view(), name='search_posts'),
    path('search_drafts/', search_views.SearchDrafts.as_view(), name='search_drafts'),
    re_path(r'^post/(?P<pk>\d+)/like/$', views.like_post, name='like_post'),
]